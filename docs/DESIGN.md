...
Card: note GUID + template ordinal, content placement, and immutable nullable creation time
...
LocalStudyProfile: scheduler implementation/version, parameters, and display policy; deck daily limits sync separately
