...
| Create Note Copy | Native transaction clones fields, tags, notetype, and all cards/decks as New | Empty-intent operation is live on rolling | Behavior is aligned; copied-note/card mirror coverage passed disposable compatibility run `34542231171` and awaits review |
